...
const char * const BITCOIN_CONF_FILENAME = "dhanacash.conf";
const char * const BITCOIN_PID_FILENAME = "dhanacash.pid";
...
{
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\DhanaCash
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\DhanaCash
    // Mac: ~/Library/Application Support/DhanaCash
    // Unix: ~/.DhanaCash
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "DhanaCash";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/DhanaCash";
#else
    // Unix
    return pathRet / ".DhanaCash";
#endif
#endif
}
