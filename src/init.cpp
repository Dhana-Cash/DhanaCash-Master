...
#include "config/dhanacash-config.h"
#endif
...
void PrepareShutdown()
{
    ...
    RenameThread("dhanacash-shutoff");
...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-zmqpubhashtxlock=<address>", _("Enable publish hash transaction (locked via InstaDCAS) in <address>"));
    ...
    strUsage += HelpMessageOpt("-zmqpubhashinstantsenddoublespend=<address>", _("Enable publish transaction hashes of attempted InstaDCAS double spend in <address>"));
    strUsage += HelpMessageOpt("-zmqpubrawblock=<address>", _("Enable publish raw block in <address>"));
    strUsage += HelpMessageOpt("-zmqpubrawtx=<address>", _("Enable publish raw transaction in <address>"));
    strUsage += HelpMessageOpt("-zmqpubrawtxlock=<address>", _("Enable publish raw transaction (locked via InstaDCAS) in <address>"));
    strUsage += HelpMessageOpt("-zmqpubrawinstantsenddoublespend=<address>", _("Enable publish raw transactions of attempted InstaDCAS double spend in <address>"));
#endif
    ...
    strUsage += HelpMessageOpt("-litemode", strprintf(_("Disable all DhanaCash specific functionality (Masternodes, PrivateSend, InstaDCAS, Governance) (0-1, default: %u)"), 0));
...
//#endif // ENABLE_WALLET
    ...
    strUsage += HelpMessageGroup(_("InstaDCAS options:"));
...
void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("dhanacash-loadblk");
...
/** Sanity checks
 *  Ensure that DhanaCash is running in a usable environment with all
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single DhanaCash process is using the data directory.
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    // lite mode disables all DhanaCash-specific functionality
    ...
    // ********************************************************* Step 10c: schedule DhanaCash-specific tasks
