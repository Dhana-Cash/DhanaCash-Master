 ...
 *
 * This is the developer documentation of the reference client for an experimental new digital currency called DhanaCash (https://www.dhana.cash/),
 * which enables instant payments to anyone, anywhere in the world. DhanaCash uses peer-to-peer technology to operate
...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        {
#if HAVE_DECL_DAEMON
            fprintf(stdout, "DhanaCash server starting\n");
