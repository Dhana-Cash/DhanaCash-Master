    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        setWindowTitle(tr("About DhanaCash-Qt"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  dhanacash-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the DhanaCash in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 DCAS, 0.01 DCAS, 0.1 DCAS, 1 DCAS and 10 DCAS -- sort of like the paper money you use every day.</li> \
