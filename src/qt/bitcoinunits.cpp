...
QString BitcoinUnits::name(int unit)
{
    if(Params().NetworkIDString() == CBaseChainParams::MAIN)
    {
        switch(unit)
        {
            case PAC: return QString(" DCAS");
            case mPAC: return QString(" mDCAS");
            case uPAC: return QString::fromUtf8(" μDCAS");
    ...
    else
    {
        switch(unit)
        {
            case PAC: return QString(" tDCAS");
            case mPAC: return QString(" mtDCAS");
            case uPAC: return QString::fromUtf8(" μtDCAS");
...
QString BitcoinUnits::description(int unit)
{
    if(Params().NetworkIDString() == CBaseChainParams::MAIN)
    {
        switch(unit)
        {
            case PAC: return QString("DhanaCash");
            case mPAC: return QString("Milli-DhanaCash (1 / 1" THIN_SP_UTF8 "000)");
            case uPAC: return QString("Micro-DhanaCash (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
            case duffs: return QString("Ten Nano-DhanaCash (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
            default: return QString("???");
        }
    }
    else
