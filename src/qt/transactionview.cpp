    ...
    transactionView(0), abandonAction(0), columnResizingFixer(0)
{
    ...
    instantsendWidget->addItem(tr("Locked by InstaDCAS"), TransactionFilterProxy::InstantSendFilter_Yes);
    instantsendWidget->addItem(tr("Not locked by InstaDCAS"), TransactionFilterProxy::InstantSendFilter_No);
...
void TransactionView::showAddressQRCode()
{
    ...
    dialog->setInfo(tr("QR code"), "dcas:"+strAddress, "", strAddress);
    dialog->show();
}
