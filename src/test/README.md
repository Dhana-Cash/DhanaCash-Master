...
To run the dhanacash-qt tests manually, launch `src/qt/test/test_dash-qt`

To add more dhanacash-qt tests, add them to the `src/qt/test/` directory and
...
unit testing framework, and since DhanaCash Core already uses boost, it makes
